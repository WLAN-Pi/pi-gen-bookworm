...
apt-get install -y --allow-downgrades /tmp/wlanpi-fpms_1.4.14_arm64_trixie.deb
...
rm -f /tmp/wlanpi-core_2.1.10-2_arm64.deb /tmp/wlanpi-fpms_1.4.14_arm64_trixie.deb /tmp/wlanpi-common_1.1.43+trixie2_arm64.deb /tmp/wlanpi-webui_1.4.0-2_arm64.deb
EOF
